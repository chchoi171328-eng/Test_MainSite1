  ...
  return (
    <>
      ...
      >
        <ProcedureTimeline
          steps={[
            {
              title: '현황 파악',
              desc: '무엇을 주장할 수 있는지는 현황을 정확히 아는 데서 정해집니다. 공사 진행 상황과 공종별 업무 현황, 기술적 요구사항을 정리하고, 계약서와 그 시점까지 작성된 서류를 검토해 현황과 계약 내용을 대조하는 단계입니다.',
              can: '할 수 있는 것 — 공정·기성 현황과 공종별 수행 범위의 정리, 기술적 요구사항의 확인, 계약서(일반·특수조건)와 그동안 오간 공문·회의록의 검토, 그리고 현황과 계약의 대조. 다툴 지점과 그 계약상 근거가 여기서 잡힙니다.',
            },
            {
              title: '클레임 — 서신 공방',
              desc: '정리된 현황을 근거로 클레임 레터를 보내고 반박 서신이 오가며, 양쪽의 주장과 근거가 문서로 고정되는 단계입니다. 이 단계의 기록이 마지막 단계의 증거가 됩니다.',
              can: '할 수 있는 것 — 클레임 레터의 설계(계약 조항과 사실관계의 연결), 통지 기한 조항의 준수, 상대 서신에 대한 인정·반박의 수위 조절. 이 서신들은 나중에 법정에서 읽히는 문서라는 전제로 써야 합니다.',
            },
            {
              title: '정산 협상',
          ...
          close="대응은 소송에서 시작되는 것이 아니라, 현황을 정확히 아는 데서 시작됩니다."
        />
      </PSection>
      ...
      <PracticeCta
        ...
        note={
          <>
            법무법인 명(SOL &amp; LUNA)은 경기도 평택시 소재 법무법인입니다. 플랜트 분쟁은 관할
            법원이 어디든 수행합니다.
          </>
        }
      />
